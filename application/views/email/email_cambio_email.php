			 ...
			 <td>
				<table class="table-resp" align="center" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
					...
					<tr>
						...
						padding: 20px 50px;
						color: rgb(85, 85, 85)">
							<h3>Has cambiado tu correo asociado a tu cuenta en Cedip</h3>
							<p >Ahora este es tu correo de recuperación de contraseña. Si no has solicitado ningún cambio ignora este correo.</p>
							<button style="
							font-size: 16px;
							...
							border-radius: 5px;
							cursor: pointer;">
							<a href="http://cedipcentromedico.com/" style="text-decoration: none; color: black;">Acceso al portal</a></button>
						</td>
					</tr>
