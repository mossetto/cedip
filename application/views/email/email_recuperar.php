...
<title>Cedip Centro Médico - Recuperación</title>
		...
		<tr>
			 <td>
				<table class="table-resp" align="center" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
					<tr>
						<td style="background-color: #107cbd;padding: 12px 50px;">
					...
					<tr>
						<td style="background-color: rgb(252, 252, 252);padding: 20px 50px;color: rgb(85, 85, 85)">
							...
							<button style="
								...
								border-radius: 5px;
								cursor: pointer;">
								<a href="http://cedipcentromedico.com/" style="text-decoration: none; color: black;">Acceso al portal</a>
							</button>
						</td>
					</tr>
					<tr>
						<td style="background-color: #107cbd;padding: 20px 50px;font-size: 13px;">
