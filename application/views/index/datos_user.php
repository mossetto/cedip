                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="pages-profile.html"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Carlos David Bowie</a>
                            <a href="<?= base_url(); ?>index.php/index/login" class="btn waves-effect waves-light btn-danger">Salir</a>
                        </li>
                    </ul>
                </div>
            </nav>
                        ...
                        <div class="card">
                            <div class="card-block">
                                <center class="m-t-30"> <img src="<?= base_url(PATH_PANEL)?>/images/users/1.jpg" class="img-circle"
                                        width="150" />
                                    <h4 class="card-title m-t-10">Carlos David Bowie</h4>
                                    <h6 class="card-subtitle">Titular</h6>
                                    <div class="row text-center justify-content-md-center">
                                        <div class="col-12"><a >
                                                    <h4 class="card-title m-t-10">#321513</h4>
                        ...
                        <div class="card">
                            <div class="card-block">
                                <form class="form-horizontal form-material">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Nombre y apellido"
                                                class="form-control form-control-line" value="Carlos David Bowie">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                            <input type="email" placeholder="Carga tu email"
                                                class="form-control form-control-line" name="example-email"
                                                id="example-email" value="carlos-david@test.com">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="number" placeholder="Teléfono de contacto"
                                                class="form-control form-control-line" value="321564787">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Tu domicilio"
                                                class="form-control form-control-line" value="Calle 123 Piso A J">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <label class="col-md-12 text-danger">Valor inerrecto, revisa el campo</label>
                                </form>
                            </div>
                        </div>
                    </div>
