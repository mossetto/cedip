...
<body style="background-color: #999999;">
		...
		<div class="notificacion" id="notificación" onclick="cerrar(this)">
			...
			<p>Recibirás un email de confirmación, revisalo para completar el registro. Gracias</p>
			...
			<div class="wrap-login100 ">
				...
				<form class="login100-form validate-form p-l-50 p-r-50 p-t-72 p-b-50">
					...
					<div class="wrap-input100 validate-input" data-validate = "Revisa este campo">
						...
						<input class="input100" type="email" name="repeat-pass" placeholder="Reingresa tu email">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate = "Revisa este campo">
						...
						<input class="input100" type="text" name="repeat-pass" placeholder="Reingresa la contraseña">
						<span class="focus-input100"></span>
					</div>
