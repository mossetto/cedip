...
<!-- FIN MODAL-->
   ...
   <script>
	...
	calendario = new MarioOliveraCalendar(meses,mes_actual,"calendario","calendario_botonera","calendario_mes",anio);	
                    ...
                    var fecha = anio+"-"+mes_actual+"-"+dia_actual;
                    
                    $.ajax
                    ({
                        type:'POST',
                        url: "<?php echo base_url();?>index.php/Profesional/getTurnosProfesional",
                        data:{},
        ...
        $("#mes_escritorio_profesional").change(function(){
            actualizar_calendario();
        });
        
        $("#anio_escritorio_profesional").change(function(){
            actualizar_calendario();
        });
        
         $("#especialidad_escritorio_profesional").change(function(){
            actualizar_calendario();
        });
    ...
    function optionsFormatterEspecialidadProfesional(value, row, index) {
        return [        
            '<a class="btn btn-primary" href="#" onclick = "administrar_especialidad_profesional('+row.codigo+')";>',
                'Administrar',
            '</a>'  
        ].join('');
    ...
    function getHorariosDia(dia,mes,id)
    {
       ...
       $.ajax({
           type:"POST",
           url: "<?php echo base_url()?>index.php/Profesional/getHorariosDia",
    ...
    {
        $("#tabla_turnos_hoy_profesional").removeAttr("hidden");
        $("#tabla_historial_turnos_profesional").attr("hidden","true");
    ...
    {
        $("#tabla_turnos_hoy_profesional").attr("hidden","true");
        $("#tabla_historial_turnos_profesional").removeAttr("hidden");  
    }
    ...
    function render_editar_historia_clinica(codigo_historia_clinica,dni)
    {
        $.ajax({
               type:"POST",
               url: "<?php echo base_url()?>index.php/profesional/render_editar_historia_clinica",
    ...
    {
        var mes = document.getElementById('mes_escritorio_profesional').value;
        var anio = document.getElementById('anio_escritorio_profesional').value;
        var especialidad = document.getElementById('especialidad_escritorio_profesional').value;
        
        if(!isNaN(mes) && !isNaN(anio) && !isNaN(especialidad))
        {
            
            $.ajax
                    ({
                        type:'POST',
                        url: "<?php echo base_url();?>index.php/Profesional/getTurnosProfesionalPorMesAnioEspecialidad",
                        data:{especialidad:especialidad,mes:mes,anio:anio},
        ...
        //$.post("<?php echo base_url();?>index.php/Profesional",{},function(){},"JSON");
    }
    
    function atender_turno(codigo_turno,estado,dni,especialidad)
    {
        alert(especialidad);
         $.ajax({
               type:"POST",
               url: "<?php echo base_url()?>index.php/Profesional/atender_turno",
               data:{codigo:codigo_turno},
        ...
        $.ajax({
               ...
               data:{codigo:codigo_turno,estado:"cumplido"},
        ...
        $.ajax({
               type:"POST",
               url: "<?php echo base_url()?>index.php/Profesional/getHistoriaClinicaPorTurno",
               data:{turno:codigo_turno},

               beforeSend: function(event){},
               success: function(data){
                   data = JSON.parse(data);
                   render_editar_historia_clinica(data[0]["codigo"],dni);
               },
               errror: function(event){alert("ERROR!")},
           });
    ...
    function listar_liquidacion_obras_sociales()
    {
        ...
        $.ajax({
            ...
            error: function(data){aler("ERROR!")},
        });
    }
    ...
    // ADMINISTRADOR YA LO TIENE
    function render_editar_historia_clinica(codigo_historia_clinica,dni)
    {
        $.ajax({
               type:"POST",
               url: "<?php echo base_url()?>index.php/Secretaria/render_editar_historia_clinica",
               data:{codigo:codigo_historia_clinica,dni:dni},
...
//                   alert(data);
    ...
    {
        var especialidad= $("#especialidad_escritorio_profesional").val();
