...
<!-- ./wrapper -->
    ...
    <div class="modal fade" id="myModalVerDetalle" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="box">
    ...
    <div class="modal fade" id="modal-historia-clinica-paciente" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body" id="cuerpo-modal-historia-clinica-paciente">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body" id="">
                            <?php
                                ...
                                echo form_open('secretaria/registrar_movimiento', $attributes);
                ...
                <div class="modal-body">
                    <div class="box">
                        ...
                        <div class="box-body" id="cuerpo-editar-texto-datos-home">
                            <form method="post" action="<?php echo base_url()?>index.php/Adminisytrador/actualizar_texto_dato_home">
...
<!-- FIN MODAL-->
   ...
   <script>
	...
	calendario = new MarioOliveraCalendar(meses,mes_actual,"calendario","calendario_botonera","calendario_mes",anio_actual);	
        ...
        if(document.getElementById('especialidad_turnero').value != "nada")
            {
                ...
                {
                    alert2("<img src='<?php echo base_url()?>recursos/img/pagina/peligro.png' width='50'/>  <p style='text-align: center;'>SELECCIONE UN PROFESIONAL</p>");
                }
            }
            else
            {
    ...
    function administrar_historia_clinica_paciente(dni)
    {
        $.ajax(
        {
            ...
            success: function(data)
            {
                ...
                for(var i=0; i < data.length;i++)
                {
                    html+="<tr><td>"+data[i]["fecha"]+"</td><td>"+data[i]["profesional"]+"</td><td>"+data[i]["especialidad"]+"</td><td>"+data[i]["observaciones"]+"</td><td><button class='btn btn-success' onClick='render_ver_historia_clinica("+data[i]["codigo"]+","+data[i]["dni_paciente"]+")'>Ver</button></td></tr>";
                }
                html+="</table>";
    ...
    function optionsFormatterVerRegistroHistoriaClinica(value, row, index) {
        return [        
            '<a class="btn btn-success" href="#" onclick = "render_ver_historia_clinica('+row.codigo+','+row.dni+')";>',
                'edit',
            '</a>'  
        ].join('');
        //document.getElementById("cerrar_id").click();
    ...
    function render_ver_historia_clinica(codigo_historia_clinica,dni)
    {
        $.ajax({
               type:"POST",
               url: "<?php echo base_url()?>index.php/Secretaria/render_ver_historia_clinica",
               data:{codigo:codigo_historia_clinica,dni:dni},
    ...
    function optionsFormatterAdministrarTurno(value, row, index) {
        return [        
            '<a class="btn btn-primary" style="width: 5px" href="#" onclick = "administrar_turno('+row.codigo+')";>',
                ' ',
            '</a>'  
        ].join('');
        //document.getElementById("cerrar_id").click();
...
//                   alert(data);
    ...
    function optionsFormatterHistoriasClinicas(value, row, index) {
        return [        
            ...
            '</a>'
            ,
            ' <a class="btn btn-success" href="<?php echo base_url() ?>index.php/Secretaria/ver_odontograma/'+row.codigo+'">',
                'Odontograma',
            '</a>'
        ].join('');
    };
