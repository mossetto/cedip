	...
	<div class="header">
		<div class="container">
			<div class="header-logo">
				<a href="index.html"><img src="<?php echo base_url()?>recursos/home/images/logo.png" width="300" alt="logo"/></a>					
			</div>
			<div class="header-info">
				...
				<h4>000-1234-1234</h4>
                                <div style="text-align: right;margin-top: 10px;">
                                    <input type="button" class="btn btn-default form-control" value="Ingreso">
                                </div>
			</div>			
	...
	<div class="header-bottom">
		<div class="container">
			...
			<div class="top-nav cl-effect-5">
				<span class="menu-icon"><img src="<?php echo base_url()?>recursos/home/images/menu-icon.png" alt=""/></span>		
				<ul class="nav1">
	...
	<div class="work">		
		<div class="container">	
			...
			<div class="col-md-4 work-grids">
				<ul>
					<li><img src="<?php echo base_url()?>recursos/home/images/icon2.png" alt=""></li>
					<li>
			...
			<div class="col-md-4 work-grids">
				<ul>
					<li><img src="<?php echo base_url()?>recursos/home/images/icon3.png" alt=""></li>
					<li>
			...
			<div class="col-md-4 work-grids">
				<ul>
					<li><img src="<?php echo base_url()?>recursos/home/images/icon4.png" alt=""></li>
					<li>
	...
	<div class="like">		
		<div class="container">
			...
			<div class="col-md-3 like-grids">
				<a href="#">
					<img src="<?php echo base_url()?>recursos/home/images/icon1.png" alt=""/>
				</a>
				<p>Facebook</p>
			</div>
			<div class="col-md-3 like-grids">
				<a href="#">
					<img src="<?php echo base_url()?>recursos/home/images/icon5.png" alt=""/>
				</a>
				<p>Twitter</p>
			</div>
			<div class="col-md-3 like-grids">
				<a href="#">
					<img src="<?php echo base_url()?>recursos/home/images/icon6.png" alt=""/>
				</a>
				<p>Pinterest</p>
			</div>
			<div class="col-md-3 like-grids">
				<a href="#">
					<img src="<?php echo base_url()?>recursos/home/images/icon7.png" alt=""/>
				</a>
				<p>Googleplus</p>
			</div>
			<div class="clearfix"> </div>
