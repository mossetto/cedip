    ...
    <body class="hold-transition skin-green-light sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                echo form_open('Administrador/filtrar_reporte_cobros', $atributes);?>    
                    <div class='row'>
                        <div class='col-md-12'>
                            <div class='box box-default'>
                                <div class='box-body' style='background-color: #00c0ef;'>
                                    ...
                                    <div class='col-xs-2 col-md-2'>
                                        ...
                                        <select id="tipo_cobro" class='form-control' name='tipo_cobro' multiple>
                                    ...
                                    <div class='col-xs-2 col-md-2'>
                                        ...
                                        <select id="obra_social" class='form-control' name='obra_social' multiple>
                                            <option value="t" selected="">Todos</option>
                                            <?php 
                  ...
                  <div class='col-md-12'>
                        <div class='box box-default'>
                            <div class='box-header'>
                                <h3 class='box-title'>Resultado de la consulta: $ <?php echo $total_consulta; ?> </h3>
